...
export const DemoControlPanel: React.FC<DemoControlPanelProps> = ({ currentView, setCurrentView }) => {
  ...
  const handleRoleSwitch = (targetRole: UserRole) => {
    ...
    // Auto switch corresponding dashboard/portal views
    ...
    <div style={{
      ...
      {isOpen && (
        <div className="glass-card animate-slide-up" style={{
          ...
          {/* View Navigations (For testing all screens) */}
          <div>
