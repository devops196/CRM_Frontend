 ...
 * Columns: User, Role, Status, Available Credits, Total Credits, Usage (% Remaining + Indicator).
 */
const TeamMemberRow: React.FC<TeamMemberRowProps> = ({ member, isOwner = false }) => {
  ...
  return (
    <tr style={{ transition: 'background-color var(--transition-fast)' }}>
      {/* Member column — avatar + name + email + employee ID */}
      ...
      {/* Usage / Remaining percentage & health level badge column */}
      <td style={{ padding: '0.85rem 1.25rem' }}>
