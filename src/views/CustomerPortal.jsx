              ...
              {selectedInvoice ? (
                <div style={{
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem' }}>
                    ...
                    <button onClick={() => typeof window !== 'undefined' && window.print()} className="btn btn-secondary" style={{ flex: 1, padding: '0.4rem', fontSize: '0.75rem' }}>
        ...
        <div className="modal-overlay">
          <div className="modal-content" style={{ maxWidth: '400px' }}>
            <div className="modal-header">
              ...
              <button onClick={() => setCheckoutInvoice(null)} style={{ background: 'none', border: 'none', fontSize: '1.2rem', cursor: 'cursor', color: 'var(--text-secondary)' }}>×</button>
            </div>
