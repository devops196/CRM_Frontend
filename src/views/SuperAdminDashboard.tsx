...
import type { Organization } from '../contexts/CRMStateContext';
...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const [selectedPlan, setSelectedPlan] = useState<'starter' | 'pro' | 'business' | 'enterprise'>('enterprise');
  ...
  const handlePlanChange = (orgId: string, newPlan: Organization['plan']) => {
    let rev = 990;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', fontFamily: 'var(--font-sans)' }}>
      ...
      {/* Row: Add Organization & Audit Logs */}
      ...
      {/* Login Attempts Mandatory Audit Log Table */}
      <LoginAttemptsTable />
